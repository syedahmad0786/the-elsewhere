...
export const destinations: Destination[] = [
  ...
  { name: "Elsewho", href: "https://elsewho.vercel.app", kind: "cabinet", external: true },
  { name: "Jigmoji", href: "https://jigmoji.vercel.app", kind: "cabinet", external: true },
  { name: "Mood Pointer", href: "https://mood-pointer.vercel.app", kind: "cabinet", external: true },
  { name: "Pixel Penance", href: "https://pixel-penance.vercel.app", kind: "cabinet", external: true },
  { name: "Pet the Void", href: "https://pet-the-void.vercel.app", kind: "original", external: true },
  { name: "Hunted 404", href: "https://hunted-404.vercel.app", kind: "original", external: true },
